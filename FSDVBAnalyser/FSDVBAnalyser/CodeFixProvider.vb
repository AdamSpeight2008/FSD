...
'<ExportCodeFixProvider(LanguageNames.VisualBasic, Name:=NameOf(FSD_VB_AnalyserCodeFixProvider)), [Shared]>
'Public Class FSD_VB_AnalyserCodeFixProvider
...
'        Get
'            Return ImmutableArray.Create(FSD_VB_AnalyserAnalyzer.DiagnosticId)
'        End Get
'    End Property
